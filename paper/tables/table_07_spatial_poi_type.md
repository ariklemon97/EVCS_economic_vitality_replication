...
*Note.* POI-type heterogeneity is estimated using the preferred stacked spatial competition design. The updated estimates do not isolate a single POI type as the clear source of the average DC fast competitor association.
